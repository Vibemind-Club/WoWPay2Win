...
import { REGIONS_DATA_DIR, ITEMS_DATA_DIR, ITEMS_ICON_DIR, TIERS_CONFIG_DIR, TIERS_ICON_DIR, AUCTIONS_DATA_DIR, SOCKET_BONUS_ID_DATA_FILE, SECONDARY_BONUS_ID_DATA_FILE, DIFFICULTY_BONUS_ID_DATA_FILE, ITEMLEVEL_BONUS_ID_DATA_FILE } from '../src/common/Constants.ts'
...
export const buildConstants = {
    ...
    __DIFFICULTY_BONUS_ID_DATA_FILE__: JSON.stringify(path.resolve(DIFFICULTY_BONUS_ID_DATA_FILE)),
    __ITEMLEVEL_BONUS_ID_DATA_FILE__: JSON.stringify(path.resolve(ITEMLEVEL_BONUS_ID_DATA_FILE)),
}
